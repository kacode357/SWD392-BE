...
namespace BusinessLayer.Service
{
    public interface IShirtService
    {
        ...
        Task<BaseResponse<ShirtResponseModel>> UpdateShirtAsync(UpdateShirtRequestModel model, int id);
        ...
        Task<DynamicResponse<ShirtResponseModel>> SearchShirtBySessionClubPlayerShirtTypeShirtName(SearchShirtByMutilName model);
    }
}
